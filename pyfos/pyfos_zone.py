...
:mod:`pyfos_zone` - PyFOS module to provide rest support for Zoning.
*********************************************************************************************************
The :mod:`pyfos_zone` provides a REST support for Zoning.
...
class defined_configuration(pyfos_rest_util.rest_object):
    ...
    *Object methods*
        ...
        .. method:: post()
            ...
            :param session: session handler returned by
                :func:`pyfos_auth.login`
            :rtype: disctionary of error or success response
    ...
    *Attribute methods*
    ...
    @staticmethod
    def get(session):
        return pyfos_rest_util.get_all(session, defined_configuration)
...
class effective_configuration(pyfos_rest_util.rest_object):
    ...
    *Object methods*
        ...
        .. method:: patch()
            ...
            Example usage of the method to save an cfg::
                ...
                effective_configuration_obj =
                    pyfos_newzone.effective_configuration()
                effective_configuration_obj.set_cfg_action(pyfos_zone.CFG_ACTION_SASVE)
                effective_configuration_obj.set_checksum(
                    current_effective_configuration.peek_checksum())
                effective_configuration_obj.patch(session)
    ...
    *Attribute methods*
    ...
    @staticmethod
    def get(session):
        return pyfos_rest_util.get_all(session, effective_configuration)
