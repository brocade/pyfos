...
# lldp_profile_tlv_del.py(pyGen v1.0.0)


"""

:mod:`lldp_profile_tlv_del` - PyFOS util to delete for lldp_profile
*******************************************************************************
The :mod:`lldp_profile_tlv_del` PyFOS util to delete for lldp_profile


The LLDP profile.

lldp_profile_tlv_del : usage
...
.. function:: lldp_profile_tlv_del.delete_lldp_profile(session,\
enabled_tlvs_tlv, name)
    ...
    *Delete lldp_profile*
        ...
        Example Usage of the Method::
            ...
            ret = lldp_profile_tlv_del.delete_lldp_profile(session,\
            enabled_tlvs_tlv, name)
            print (ret)
...
def delete_lldp_profile(session, enabled_tlvs_tlv=None, name=None):
    lldp_profileObj = lldp_profile()
    lldp_profileObj.set_enabled_tlvs_tlv(enabled_tlvs_tlv)
    lldp_profileObj.set_name(name)
