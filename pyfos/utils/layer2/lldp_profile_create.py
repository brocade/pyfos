...
# lldp_profile_create.py(pyGen v1.0.0)


"""

:mod:`lldp_profile_create` - PyFOS util to create for lldp_profile
*******************************************************************************
The :mod:`lldp_profile_create` PyFOS util to create for lldp_profile


The LLDP profile.

lldp_profile_create : usage
...
.. function:: lldp_profile_create.create_lldp_profile(session, name)

    *Create lldp_profile*

        Example Usage of the Method::

            ret = lldp_profile_create.create_lldp_profile(session, name)
            print (ret)
...
def create_lldp_profile(session, name=None):
    lldp_profileObj = lldp_profile()
    lldp_profileObj.set_name(name)
