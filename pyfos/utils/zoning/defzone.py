...
:mod:`defzone` - PyFOS util for specific Zoning use case.
***********************************************************************************
The :mod:`defzone` provides for specific Zoning use case.
...
* inputs:
    ...
    * -a=<1 or 0>: All access mode enabled or not
...
def usage():
    print("usage:")
    print('defzone.py -i <ipaddr> -a <mode in bool>')
