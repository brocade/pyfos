...
:mod:`zoning_zone_create_add` - PyFOS util for specific Zoning use case.
***********************************************************************************
The :mod:`zoning_zone_create_add` provides for specific Zoning use case.

This module is a standalone script and API that can be used to create
new Zone(s) or add to existing Zone(s).
...
* inputs:
    ...
    * --name=<zonename>: string name of a new Zone.
