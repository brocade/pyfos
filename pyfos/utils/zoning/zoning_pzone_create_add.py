...
:mod:`zoning_pzone_create_add` - PyFOS util for specific Zoning use case.
***********************************************************************************
The :mod:`zoning_pzone_create_add` provides for specific Zoning use case.

This module is a standalone script and API that can be used to create
new Peer Zone(s) or add to existing Peer Zone(s).
...
def pzonecreate(session, zones):
    ...
    Example usage of the method::
        ...
        result = pzonecreate(session, zones)
    ...
    *use cases*
        ...
        1. create new Peer Zone(s) with provided member(s)
        2. add new member(s) to existing Peer Zone(s)
