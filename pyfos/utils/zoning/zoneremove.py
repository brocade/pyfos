...
:mod:`zoneremove` - PyFOS util for specific Zoning use case.
***********************************************************************************
The :mod:`zoneremove` provides for specific Zoning use case.
...
def usage():
    print("usage:")
    print('zoneremove.py -i <ipaddr> -n <name> -m <members>')
