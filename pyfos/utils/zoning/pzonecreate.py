...
:mod:`pzonecreate` - PyFOS util for specific Zoning use case.
***********************************************************************************
The :mod:`pzonecreate` provides for specific Zoning use case.
...
def usage():
    print("usage:")
    print('pzonecreate.py -i <ipaddr> -n <name>'
