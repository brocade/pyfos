...
"""
:mod:`maps_dashboard_misc_show` - PyFOS util to display database information.
*****************************************************************************

Displays the MAPS start time and dashboard information.
...
* Output:
    The MAPS start time and miscellaneous information.
