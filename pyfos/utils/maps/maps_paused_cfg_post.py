...
:mod:`maps_paused_cfg_post` - PyFOS util to pause MAPS monitoring for members.
*******************************************************************************

This script is used to pause MAPS monitoring for members.
