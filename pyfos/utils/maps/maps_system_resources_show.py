...
"""
:mod:`maps_system_resources_show` - PyFOS util to display MAPS system resources
*******************************************************************************
...
* output:
    ...
    Displays usage of system resources.
    System resources displayed are CPU usage, Memory usage,
