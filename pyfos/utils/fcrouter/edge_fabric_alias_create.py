...
# edge_fabric_alias_create.py(pyGen v1.0.0)
...
.. function:: edge_fabric_alias_create.create_edge_fabric_alias(session,\
edge_fabric_id, alias_name)
    ...
    *Create edge_fabric_alias*
        ...
        Example Usage of the Method::
            ...
            ret = edge_fabric_alias_create.create_edge_fabric_alias(session,\
            edge_fabric_id, alias_name)
            print (ret)
...
def _create_edge_fabric_alias(session, edge_fabric_aliasObj):
    return edge_fabric_aliasObj.post(session)


def create_edge_fabric_alias(session, edge_fabric_id=None, alias_name=None):
    edge_fabric_aliasObj = edge_fabric_alias()
    edge_fabric_aliasObj.set_edge_fabric_id(edge_fabric_id)
    edge_fabric_aliasObj.set_alias_name(alias_name)
    return _create_edge_fabric_alias(session, edge_fabric_aliasObj)
...
def main(argv):
    ...
    result = _create_edge_fabric_alias(session, inputs['utilobject'])
