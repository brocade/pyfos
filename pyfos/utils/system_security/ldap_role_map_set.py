...
:mod:`ldap_role_map_set` - PyFOS util for ldap role map attributes
***********************************************************************************
This module is a standalone script and API that can be used to modify
LDAP role attributes.
...
* Util scripts options:
    ...
    --switch-role                               set Switch role name
    --homeAD                                    set home virtual fabric
    --chassis-access-role                       set chassis access role name
