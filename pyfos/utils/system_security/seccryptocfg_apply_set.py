...
:mod:`seccryptocfg_apply_set` - PyFOS util to apply the default/user
                                defined template
******************************************************************************
The :mod:`seccryptocfg` supports 'seccryptocfg' CLI use case.

This module is a standalone script and API that can be used to apply the
default/user defined template
