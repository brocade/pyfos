...
:mod:`user_config_create` - PyFOS util to create an user account
*************************************************************************************
The :mod:`user_config_create` supports 'userconfig' CLI use case.
...
def main(argv):
    filters = ["name", "password", "role", "home_virtual_fabric",
               "virtual_fabric_role_id_list_role_id", "account_description",
               "account_enabled", "password_change_enforced",
               "access_start_time", "access_end_time", "chassis_access_role"]
