...
:mod:`raslog_module_get` - PyFOS util for configuring raslog_module op use case
*******************************************************************************
The :mod:`raslog_module_get` provides for configuring raslog_module op use case
...
.. function:: show_raslog_module(session)
        ...
        Example usage of the method::
            ...
            ret = raslog_module_get.show_raslog_module(session, module_id)
            print (ret)

        Details::

            result = raslog_module_get.show_raslog_module(
              session, 'AUTH')
