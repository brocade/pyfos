...
# traffic_control_list_create.py(pyGen v1.0.0)


"""

:mod:`traffic_control_list_create` - PyFOS util to create for\
 traffic_control_list
******************************************************************************\
*******************************************************************************
The:mod:`traffic_control_list_create` PyFOS util to create for\
 traffic_control_list


Represents traffic control lists in order to manage IP Extension LAN flows.

traffic_control_list_create: usage
...
.. function:: traffic_control_list_create.create_traffic_control_list(session,\
...
non_terminated_enabled)
    ...
    *Create traffic_control_list*

    Example Usage of the Method::

            ret =\
 traffic_control_list_create.create_traffic_control_list(session,\
 target_ve_port, action, segment_preservation_enabled, port,\
 traffic_control_list_name, source_address, target_slot, target_dp_id,\
 l4_protocol, target_qos, reset_propagation_enabled,\
 source_address_prefix_length, application,\
 ...
 traffic_control_listObj.set_non_terminated_enabled(non_terminated_enabled)
        ret = _create_traffic_control_list(session, traffic_control_listObj)
        print(ret)
...
def _create_traffic_control_list(session, traffic_control_listObj):
    return traffic_control_listObj.post(session)


def create_traffic_control_list(session, target_ve_port=None, action=None,
    ...
    traffic_control_listObj.set_priority(priority)
    traffic_control_listObj.set_non_terminated_enabled(non_terminated_enabled)
    return _create_traffic_control_list(session, traffic_control_listObj)
...
def main(argv):
    ...
    result = _create_traffic_control_list(session, inputs['utilobject'])
