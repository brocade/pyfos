...
.. function:: switchipinterfacecreate.create_extension_ip(session, name, dp,\
ip, prefix, vlan=None, mtu=None)
    ...
    *Create extension IP Address* 
        ...
        Example usage of the method::
            ...
            ret = switchipinterfacecreate.create_extension_ip(session, name,\
...
def _create_extension_ip(session, value_dict):
...
def create_extension_ip(session, name, dp, ip, prefix, vlan=None, mtu=None):
	...
	if mtu != None:
		value_dict.update({'mtu-size': arg})
	result = _create_extension_ip(session, value_dict)
 

def usage():
	print ("usage:")
	print ('switchipinterfacecreate.py -i <ipaddr> -n <name> ' +\
