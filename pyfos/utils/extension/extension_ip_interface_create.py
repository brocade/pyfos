...
# extension_ip_interface_create.py(pyGen v1.0.0)


"""

:mod:`extension_ip_interface_create` - PyFOS util to create for\
 extension_ip_interface
******************************************************************************\
*******************************************************************************
The:mod:`extension_ip_interface_create` PyFOS util to create for\
 extension_ip_interface


Represents the IP interface defined on extension blade or system.

extension_ip_interface_create: usage
...
.. function:: extension_ip_interface_create.create_extension_ip_interface(\
session, dp_id, vlan_id, ip_address, mtu_size, ip_prefix_length, name)

    *Create extension_ip_interface*

    Example Usage of the Method::

            ret =\
 extension_ip_interface_create.create_extension_ip_interface(session, dp_id,\
 vlan_id, ip_address, mtu_size, ip_prefix_length, name)
    ...
    Details::
        ...
        ret = _create_extension_ip_interface(session,\
...
def _create_extension_ip_interface(session, extension_ip_interfaceObj):
    return extension_ip_interfaceObj.post(session)


def create_extension_ip_interface(session, dp_id=None, vlan_id=None,
    ...
    extension_ip_interfaceObj.set_ip_prefix_length(ip_prefix_length)
    extension_ip_interfaceObj.set_name(name)
    return _create_extension_ip_interface(session, extension_ip_interfaceObj)
...
def validate(extension_ip_interfaceObj):
    if extension_ip_interfaceObj.peek_dp_id() is None or\
       ...
       extension_ip_interfaceObj.peek_ip_prefix_length() is None or\
...
def main(argv):
    ...
    result = _create_extension_ip_interface(session, inputs['utilobject'])
