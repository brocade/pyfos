...
# traffic_control_list_modify.py(pyGen v1.0.0)


"""

:mod:`traffic_control_list_modify` - PyFOS util to modify for\
 traffic_control_list
******************************************************************************\
*******************************************************************************
The:mod:`traffic_control_list_modify` PyFOS util to modify for\
 traffic_control_list


Represents traffic control lists in order to manage IP Extension LAN flows.

traffic_control_list_modify: usage
...
.. function:: traffic_control_list_modify.modify_traffic_control_list(session,\
...
non_terminated_enabled)
    ...
    *Modify traffic_control_list*

    Example Usage of the Method::

            ret =\
 traffic_control_list_modify.modify_traffic_control_list(session,\
 target_ve_port, action, segment_preservation_enabled, port,\
 traffic_control_list_name, source_address, target_slot, target_dp_id,\
 l4_protocol, target_qos, reset_propagation_enabled,\
 source_address_prefix_length, application,\
 ...
 traffic_control_listObj.set_non_terminated_enabled(non_terminated_enabled)
        ret = _modify_traffic_control_list(session, traffic_control_listObj)
        print(ret)
...
def _modify_traffic_control_list(session, traffic_control_listObj):
    return traffic_control_listObj.patch(session)


def modify_traffic_control_list(session, target_ve_port=None, action=None,
                                ...
                                cp_dp_synchronized=None, vlan=None,
                                l2cos=None, destination_address=None,
    ...
    traffic_control_listObj.set_priority(priority)
    traffic_control_listObj.set_non_terminated_enabled(non_terminated_enabled)
    return _modify_traffic_control_list(session, traffic_control_listObj)
...
def main(argv):
    ...
    result = _modify_traffic_control_list(session, inputs['utilobject'])
