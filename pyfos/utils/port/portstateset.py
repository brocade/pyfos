...
:mod:`portstateset` - PyFOS util for specific port op use case.
***********************************************************************************
The :mod:`portstateset` provides for specific port op use case.
...
def usage():
    print("usage:")
    print('portstateset.py -i <ipaddr> -n <name> -e <enable mode in bool>')
