...
class extension_iproute(pyfos_rest_util.rest_object):
    ...
    *Attribute functions*
    ...
    def __init__(self, dictvalues={}):
        super().__init__(pyfos_rest_util.rest_obj_type.iproute, "/rest/running/brocade-extension-ip-route/extension-ip-route")
        ...
        self.add(pyfos_rest_util.rest_attribute("ip-prefix-length", pyfos_type.type_str, None, pyfos_rest_util.REST_ATTRIBUTE_KEY))
        self.add(pyfos_rest_util.rest_attribute("ip-gateway", pyfos_type.type_str, None, pyfos_rest_util.REST_ATTRIBUTE_CONFIG_MANDATORY))
