...
class gigabitethernet(pyfos_rest_util.rest_object):
    ...
    Important Class Members:
           ...
           +=============================+================================+=======================================+
           | name                        |The slot/port name of           |:func:`peek_name`                      |
           |                             |the GE_Port.                    |:func:`set_name`                       |
           +-----------------------------+--------------------------------+---------------------------------------+
           | enabled-state               |The state of the GE_Port.       |:func:`peek_enabled_state`             |
           |                             |                                |:func:`set_enabled_state`              |
           +-----------------------------+--------------------------------+---------------------------------------+
           | speed                       |The speed of the GE_Port.       |:func:`peek_speed`                     |
           |                             |                                |:func:`set_speed`                      |
           +-----------------------------+--------------------------------+---------------------------------------+
           | mac-address                 |The MAC address of the GE_Port. |:func:`peek_mac_address`               |
           +-----------------------------+--------------------------------+---------------------------------------+
       ...
       *Attribute Functions*
           ...
           .. function:: set_enabled_state(enabled)
               ...
               :rtype: A dictionary of errors or a success response \
                and value with "enabled-state" as the key.
           ...
           .. function:: set_speed(speed)
               ...
               :rtype: A dictionary of errors or a success response \
                and value with "speed" as the key.
           ...
           .. function:: set_persistent_disable(disabled)
               ...
               :rtype: A dictionary of errors or a success response and \
                value with "disabled" as the key.
...
class gigabitethernet_statistics(pyfos_rest_util.rest_object):
    ...
    Important Class Members:
         ...
         |                               | the GE_Port.                  |:func:`set_name`                       |
         +-------------------------------+-------------------------------+---------------------------------------+
         | reset-statistics              | The GE_Port reset statistics. |:func:`peek_reset_statistics`          |
         |                               |                               |:func:`set_reset_statistics`           |
         +-------------------------------+-------------------------------+---------------------------------------+
         | out-pkts                      | The total out packets.        |:func:`peek_out_pkts`                  |
         +-------------------------------+-------------------------------+---------------------------------------+
         | out-octets                    | The total out octets.         |:func:`peek_out_octets`                |
         +-------------------------------+-------------------------------+---------------------------------------+
         | out-unicast-pkts              | The total out unicast         |:func:`peek_out_unicast_pkts`          |
         |                               | packets.                      |                                       |
         +-------------------------------+-------------------------------+---------------------------------------+
         | out-multicast-pkts            | The total out multicast       |:func:`peek_out_multicast_pkts`        |
         |                               | packets.                      |                                       |
         +-------------------------------+-------------------------------+---------------------------------------+
         | out-broadcast-pkts            | The total out broadcast       |:func:`peek_out_broadcast_pkts`        |
         |                               | packets.                      |                                       |
         +-------------------------------+-------------------------------+---------------------------------------+
         ...
         +-------------------------------+-------------------------------+---------------------------------------+
         | in-multicast-pkts             | The total in multicast        |:func:`peek_in_multicast_pkts`         |
         |                               | packets.                      |                                       |
         +-------------------------------+-------------------------------+---------------------------------------+
         | in-broadcast-pkts             | The total in broadcast        |:func:`peek_in_broadcast_pkts`         |
         |                               | packets.                      |                                       |
         +-------------------------------+-------------------------------+---------------------------------------+
         ...
         +-------------------------------+-------------------------------+---------------------------------------+
         | carrier-loss-error            | The total carrier loss errors.|:func:`peek_carrier_loss_error`        |
         +-------------------------------+-------------------------------+---------------------------------------+
         | crc-error                     | The total CRC errors.         |:func:`peek_crc_error`                 |
         +-------------------------------+-------------------------------+---------------------------------------+
         | jabber-error                  | The total jabber errors.      |:func:`peek_jabber_error`              |
         +-------------------------------+-------------------------------+---------------------------------------+
         | time-generated                | The time that statistics      |:func:`peek_time_generated`            |
         |                               | were generated.               |                                       |
         +-------------------------------+-------------------------------+---------------------------------------+
     ...
     *Attribute Functions*
         ...
         .. function:: set_name(name)
             ...
             Sets the name in the GE_Port stats object.
         ...
         .. function:: set_reset_statistics(reset)
             ...
             Sets the reset statistics in the GE_Port stats object.
