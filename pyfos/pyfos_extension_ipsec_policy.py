...
class extension_ipsec_policy(pyfos_rest_util.rest_object):
    ...
    *Attribute functions*
    ...
    def __init__(self, dictvalues={}):
        super().__init__(pyfos_rest_util.rest_obj_type.ipsec, "/rest/running/brocade-extension-ipsec-policy/extension-ipsec-policy")
        self.add(pyfos_rest_util.rest_attribute("policy-name", pyfos_type.type_str, None, pyfos_rest_util.REST_ATTRIBUTE_KEY))
        self.add(pyfos_rest_util.rest_attribute("profile-name", pyfos_type.type_str, None, pyfos_rest_util.REST_ATTRIBUTE_CONFIG))
        self.add(pyfos_rest_util.rest_attribute("authentication-data", pyfos_type.type_str, None,pyfos_rest_util.REST_ATTRIBUTE_CONFIG))
        self.add(pyfos_rest_util.rest_attribute("num-ike-sessions", pyfos_type.type_str, None,pyfos_rest_util.REST_ATTRIBUTE_NOT_CONFIG))
        self.add(pyfos_rest_util.rest_attribute("restart-ike-sessions", pyfos_type.type_str, None, pyfos_rest_util.REST_ATTRIBUTE_CONFIG))
